...
export default function CartItemQuantityButton({
  ...
  return (
    <div className="flex items-stretch">
      <button
        className="border-[3px] rounded-l-md hover:bg-gray-800 hover:text-white px-2 flex items-center justify-center disabled:opacity-50"
      ...
      <div className=" border-y-[3px] font-bold px-4 flex items-center justify-center min-w-[40px]">
        {quantity}
      </div>

      <button
        className=" border-[3px] rounded-r-md hover:bg-gray-800 hover:text-white px-2 flex items-center justify-center disabled:opacity-50"
